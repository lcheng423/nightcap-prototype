...
const IdeasIcon = ({ color = NAV_DARK }) => (
...
const TodayIcon = ({ color = NAV_DARK }) => (
  <div style={{ display: "flex", width: 24, height: 24, flexDirection: "column", justifyContent: "center", alignItems: "center", flexShrink: 0 }}>
...
const labelStyle = (active) => ({
  color: active ? NAV_ACTIVE_FG : NAV_DARK,
  textAlign: "center",
...
export default function NavBar({ activePage: activePageProp }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Sliding active indicator (dark brown) */}
        <div
          style={{
            position: "absolute",
            top: "50%",
        ...
        >
          <IdeasIcon color={activePage === "ideas" ? NAV_ACTIVE_FG : NAV_DARK} />
          <span style={labelStyle(activePage === "ideas")}>For you</span>
        </Link>
        ...
        >
          <TodayIcon color={activePage === "today" ? NAV_ACTIVE_FG : NAV_DARK} />
          <span style={labelStyle(activePage === "today")}>Today</span>
        </Link>
        ...
        >
          <div
            style={{
              ...
              borderRadius: 10,
              overflow: "hidden",
              boxShadow: activePage === "threads" ? "0 0 0 2px #FFF" : undefined,
            }}
          >
            <Image
              src={avatarImage}
          ...
          <span style={labelStyle(activePage === "threads")}>Threads</span>
        </Link>
      </div>
